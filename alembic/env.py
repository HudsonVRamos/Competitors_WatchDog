"""Configuração do Alembic para migrations assíncronas com asyncpg."""
...
# Sobrescrever sqlalchemy.url com a URL das settings
...
def do_run_migrations(connection: Connection) -> None:
    """Executa migrations usando uma conexão ativa."""
...
async def run_async_migrations() -> None:
    """Executa migrations no modo async."""
